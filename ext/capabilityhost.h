...
class CapabilityHost : public SchedulingHost {
 public:
  ...
  void send();
  // std::priority_queue<CapabilityFlow*, std::vector<CapabilityFlow*>,
  // CapabilityFlowComparator> active_sending_flows;
  CustomPriorityQueue<CapabilityFlow*, std::vector<CapabilityFlow*>,
                      CapabilityFlowComparator>
  ...
  // std::priority_queue<CapabilityFlow*, std::vector<CapabilityFlow*>,
  // CapabilityFlowComparatorAtReceiver> active_receiving_flows;
  CustomPriorityQueue<CapabilityFlow*, std::vector<CapabilityFlow*>,
                      CapabilityFlowComparatorAtReceiver>
      active_receiving_flows;
